...
PRODUCT_COPY_FILES += device/phh/treble/charger.rc:system/etc/init/charger.rc
PRODUCT_PACKAGES += product_charger_res_images
...
# Provide default libnfc-nci.conf file for devices that does not have one in vendor
PRODUCT_COPY_FILES += \
...
PRODUCT_PACKAGES += mtk-sms-fwk-ready

# Helper to debug motorized camera
PRODUCT_PACKAGES += \
	xiaomi-motor \
	oneplus-motor \
	asus-motor
...
PRODUCT_PACKAGES += resetprop_phh
...
PRODUCT_PACKAGES += oplus-alert-slider
