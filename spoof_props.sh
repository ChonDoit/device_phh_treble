...
resetprop_phh persist.sys.spoof.fingerprint google/oriole_beta/oriole:16/BP31.250502.008.A1/13572937:user/release-keys
resetprop_phh persist.sys.spoof.security_patch 2025-05-05
resetprop_phh persist.sys.spoof.first_api_level 31
resetprop_phh persist.sys.spoof.id BP31.250502.008.A1
resetprop_phh persist.sys.spoof.type user
resetprop_phh persist.sys.spoof.tags release-keys
resetprop_phh persist.sys.spoof.incremental 13572937
